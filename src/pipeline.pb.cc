...
extern PROTOBUF_INTERNAL_EXPORT_pipeline_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_Hash_ngram_pipeline_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_pipeline_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_Linear_classifier_pipeline_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_pipeline_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_To_lower_pipeline_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_pipeline_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_Vector_pipeline_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_pipeline_2eproto ::google::protobuf::internal::SCCInfo<1> scc_info_Naive_bayes_pipeline_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_pipeline_2eproto ::google::protobuf::internal::SCCInfo<2> scc_info_Classifier_pipeline_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_pipeline_2eproto ::google::protobuf::internal::SCCInfo<2> scc_info_Transformation_pipeline_2eproto;
namespace pipelines {
class To_lowerDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<To_lower> _instance;
} _To_lower_default_instance_;
class Hash_ngramDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<Hash_ngram> _instance;
...
class Naive_bayesDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<Naive_bayes> _instance;
} _Naive_bayes_default_instance_;
class Linear_classifierDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<Linear_classifier> _instance;
} _Linear_classifier_default_instance_;
class ClassifierDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<Classifier> _instance;
...
class PipelineDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<Pipeline> _instance;
} _Pipeline_default_instance_;
}  // namespace pipelines
static void InitDefaultsTo_lower_pipeline_2eproto() {
...
::google::protobuf::internal::SCCInfo<0> scc_info_To_lower_pipeline_2eproto =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsTo_lower_pipeline_2eproto}, {}};

static void InitDefaultsHash_ngram_pipeline_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<0> scc_info_Hash_ngram_pipeline_2eproto =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsHash_ngram_pipeline_2eproto}, {}};

static void InitDefaultsTransformation_pipeline_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<2> scc_info_Transformation_pipeline_2eproto =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 2, InitDefaultsTransformation_pipeline_2eproto}, {
      &scc_info_To_lower_pipeline_2eproto.base,
      &scc_info_Hash_ngram_pipeline_2eproto.base,}};

static void InitDefaultsVector_pipeline_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<0> scc_info_Vector_pipeline_2eproto =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsVector_pipeline_2eproto}, {}};

static void InitDefaultsNaive_bayes_pipeline_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<1> scc_info_Naive_bayes_pipeline_2eproto =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsNaive_bayes_pipeline_2eproto}, {
      &scc_info_Vector_pipeline_2eproto.base,}};

static void InitDefaultsLinear_classifier_pipeline_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<0> scc_info_Linear_classifier_pipeline_2eproto =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsLinear_classifier_pipeline_2eproto}, {}};

static void InitDefaultsClassifier_pipeline_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<2> scc_info_Classifier_pipeline_2eproto =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 2, InitDefaultsClassifier_pipeline_2eproto}, {
      &scc_info_Naive_bayes_pipeline_2eproto.base,
      &scc_info_Linear_classifier_pipeline_2eproto.base,}};

static void InitDefaultsPipeline_pipeline_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<2> scc_info_Pipeline_pipeline_2eproto =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 2, InitDefaultsPipeline_pipeline_2eproto}, {
      &scc_info_Transformation_pipeline_2eproto.base,
      &scc_info_Classifier_pipeline_2eproto.base,}};

void InitDefaults_pipeline_2eproto() {
  ::google::protobuf::internal::InitSCC(&scc_info_To_lower_pipeline_2eproto.base);
  ::google::protobuf::internal::InitSCC(&scc_info_Hash_ngram_pipeline_2eproto.base);
  ::google::protobuf::internal::InitSCC(&scc_info_Transformation_pipeline_2eproto.base);
  ::google::protobuf::internal::InitSCC(&scc_info_Vector_pipeline_2eproto.base);
  ::google::protobuf::internal::InitSCC(&scc_info_Naive_bayes_pipeline_2eproto.base);
  ::google::protobuf::internal::InitSCC(&scc_info_Linear_classifier_pipeline_2eproto.base);
  ::google::protobuf::internal::InitSCC(&scc_info_Classifier_pipeline_2eproto.base);
  ::google::protobuf::internal::InitSCC(&scc_info_Pipeline_pipeline_2eproto.base);
}

::google::protobuf::Metadata file_level_metadata_pipeline_2eproto[8];
constexpr ::google::protobuf::EnumDescriptor const** file_level_enum_descriptors_pipeline_2eproto = nullptr;
constexpr ::google::protobuf::ServiceDescriptor const** file_level_service_descriptors_pipeline_2eproto = nullptr;

const ::google::protobuf::uint32 TableStruct_pipeline_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::pipelines::To_lower, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::pipelines::Hash_ngram, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::pipelines::Hash_ngram, num_buckets_),
  PROTOBUF_FIELD_OFFSET(::pipelines::Hash_ngram, hash_sizes_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::pipelines::Transformation, _internal_metadata_),
  ~0u,  // no _extensions_
  PROTOBUF_FIELD_OFFSET(::pipelines::Transformation, _oneof_case_[0]),
  ~0u,  // no _weak_field_map_
  ...
  PROTOBUF_FIELD_OFFSET(::pipelines::Transformation, Representation_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::pipelines::Vector, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::pipelines::Vector, elements_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::pipelines::Naive_bayes, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::pipelines::Naive_bayes, classes_),
  PROTOBUF_FIELD_OFFSET(::pipelines::Naive_bayes, vectors_),
  PROTOBUF_FIELD_OFFSET(::pipelines::Naive_bayes, class_priors_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::pipelines::Linear_classifier, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::pipelines::Linear_classifier, classes_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::pipelines::Classifier, _internal_metadata_),
  ~0u,  // no _extensions_
  PROTOBUF_FIELD_OFFSET(::pipelines::Classifier, _oneof_case_[0]),
  ~0u,  // no _weak_field_map_
  offsetof(::pipelines::ClassifierDefaultTypeInternal, nb_),
  offsetof(::pipelines::ClassifierDefaultTypeInternal, lc_),
  PROTOBUF_FIELD_OFFSET(::pipelines::Classifier, classifier_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::pipelines::Pipeline, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::pipelines::Pipeline, version_),
  PROTOBUF_FIELD_OFFSET(::pipelines::Pipeline, language_),
  PROTOBUF_FIELD_OFFSET(::pipelines::Pipeline, timestamp_),
  PROTOBUF_FIELD_OFFSET(::pipelines::Pipeline, representation_),
  PROTOBUF_FIELD_OFFSET(::pipelines::Pipeline, classifier_),
};
...
::google::protobuf::internal::AssignDescriptorsTable assign_descriptors_table_pipeline_2eproto = {
  {}, AddDescriptors_pipeline_2eproto, "pipeline.proto", schemas,
  file_default_instances, TableStruct_pipeline_2eproto::offsets,
  file_level_metadata_pipeline_2eproto, 8, file_level_enum_descriptors_pipeline_2eproto, file_level_service_descriptors_pipeline_2eproto,
};

const char descriptor_table_protodef_pipeline_2eproto[] =
  ...
  "ierb\006proto3"
  ;
::google::protobuf::internal::DescriptorTable descriptor_table_pipeline_2eproto = {
  false, InitDefaults_pipeline_2eproto, 
  descriptor_table_protodef_pipeline_2eproto,
  "pipeline.proto", &assign_descriptors_table_pipeline_2eproto, 651,
};
...
void AddDescriptors_pipeline_2eproto() {
 ...
 ::google::protobuf::internal::AddDescriptors(&descriptor_table_pipeline_2eproto, deps, 0);
}

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_pipeline_2eproto = []() { AddDescriptors_pipeline_2eproto(); return true; }();
namespace pipelines {
...
const char* To_lower::_InternalParse(const char* begin, const char* end, void* object,
                  ::google::protobuf::internal::ParseContext* ctx) {
  auto msg = static_cast<To_lower*>(object);
...
// @@protoc_insertion_point(generalized_merge_from_start:pipelines.To_lower)
  ...
  const To_lower* source =
      ::google::protobuf::DynamicCastToGenerated<To_lower>(
          &from);
  if (source == nullptr) {
...
::google::protobuf::Metadata To_lower::GetMetadata() const {
  ::google::protobuf::internal::AssignDescriptors(&::assign_descriptors_table_pipeline_2eproto);
  return ::file_level_metadata_pipeline_2eproto[kIndexInFileMessages];
}
...
class Hash_ngram::HasBitSetters {
 public:
};
...
#if GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
const char* Hash_ngram::_InternalParse(const char* begin, const char* end, void* object,
                  ::google::protobuf::internal::ParseContext* ctx) {
  auto msg = static_cast<Hash_ngram*>(object);
  ::google::protobuf::int32 size; (void)size;
  int depth; (void)depth;
  ::google::protobuf::uint32 tag;
  ::google::protobuf::internal::ParseFunc parser_till_end; (void)parser_till_end;
  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      case 1: {
        ...
        msg->set_num_buckets(::google::protobuf::internal::ReadVarint(&ptr));
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        break;
      }
      ...
      case 2: {
        ...
        do {
          msg->add_hash_sizes(::google::protobuf::internal::ReadVarint(&ptr));
          GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
          if (ptr >= end) break;
...
void Hash_ngram::SerializeWithCachedSizes(
  ...
  if (this->hash_sizes_size() > 0) {
    ...
    output->WriteVarint32(_hash_sizes_cached_byte_size_.load(
...
::google::protobuf::uint8* Hash_ngram::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->hash_sizes_size() > 0) {
    ...
    target = ::google::protobuf::io::CodedOutputStream::WriteVarint32ToArray(
        _hash_sizes_cached_byte_size_.load(std::memory_order_relaxed),
         target);
...
// @@protoc_insertion_point(message_byte_size_start:pipelines.Hash_ngram)
  ...
  // repeated int32 hash_sizes = 2;
  {
    ...
    _hash_sizes_cached_byte_size_.store(cached_size,
                                    std::memory_order_relaxed);
...
// @@protoc_insertion_point(generalized_merge_from_start:pipelines.Hash_ngram)
  ...
  const Hash_ngram* source =
      ::google::protobuf::DynamicCastToGenerated<Hash_ngram>(
          &from);
  if (source == nullptr) {
...
class Transformation::HasBitSetters {
 public:
  static const ::pipelines::To_lower& to_lower(const Transformation* msg);
  static const ::pipelines::Hash_ngram& hash_ngram(const Transformation* msg);
};

const ::pipelines::To_lower&
Transformation::HasBitSetters::to_lower(const Transformation* msg) {
  return *msg->Representation_.to_lower_;
}
const ::pipelines::Hash_ngram&
Transformation::HasBitSetters::hash_ngram(const Transformation* msg) {
  return *msg->Representation_.hash_ngram_;
}
  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      case 1: {
        ...
        ptr = ::google::protobuf::io::ReadSize(ptr, &size);
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        parser_till_end = ::pipelines::To_lower::_InternalParse;
        object = msg->mutable_to_lower();
        if (size > end - ptr) goto len_delim_till_end;
        ptr += size;
      ...
      case 2: {
        ...
        ptr = ::google::protobuf::io::ReadSize(ptr, &size);
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        parser_till_end = ::pipelines::Hash_ngram::_InternalParse;
        object = msg->mutable_hash_ngram();
        if (size > end - ptr) goto len_delim_till_end;
        ptr += size;
        GOOGLE_PROTOBUF_PARSER_ASSERT(ctx->ParseExactRange(
            {parser_till_end, object}, ptr - size, ptr));
...
void Transformation::SerializeWithCachedSizes(
  ...
  if (has_to_lower()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      1, HasBitSetters::to_lower(this), output);
  }

  // .pipelines.Hash_ngram hash_ngram = 2;
  if (has_hash_ngram()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      2, HasBitSetters::hash_ngram(this), output);
  }
...
::google::protobuf::uint8* Transformation::InternalSerializeWithCachedSizesToArray(
  ...
  if (has_to_lower()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        1, HasBitSetters::to_lower(this), target);
  }
  ...
  if (has_hash_ngram()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        2, HasBitSetters::hash_ngram(this), target);
  }
  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      case 1: {
        ...
        do {
          msg->add_elements(::google::protobuf::io::UnalignedLoad<float>(ptr));
          ptr += sizeof(float);
          if (ptr >= end) break;
...
void Vector::SerializeWithCachedSizes(
  ...
  if (this->elements_size() > 0) {
    ...
    output->WriteVarint32(_elements_cached_byte_size_.load(
        std::memory_order_relaxed));
...
::google::protobuf::uint8* Vector::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->elements_size() > 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteTagToArray(
      ...
      target);
    target = ::google::protobuf::io::CodedOutputStream::WriteVarint32ToArray(
        _elements_cached_byte_size_.load(std::memory_order_relaxed),
         target);
    target = ::google::protobuf::internal::WireFormatLite::
...
class Naive_bayes::HasBitSetters {
 public:
};
...
#if GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
const char* Naive_bayes::_InternalParse(const char* begin, const char* end, void* object,
                  ::google::protobuf::internal::ParseContext* ctx) {
  auto msg = static_cast<Naive_bayes*>(object);
  ::google::protobuf::int32 size; (void)size;
  int depth; (void)depth;
  ::google::protobuf::uint32 tag;
  ::google::protobuf::internal::ParseFunc parser_till_end; (void)parser_till_end;
    ...
    switch (tag >> 3) {
      ...
      case 1: {
        ...
        do {
          ptr = ::google::protobuf::io::ReadSize(ptr, &size);
          GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
          ctx->extra_parse_data().SetFieldName("pipelines.Naive_bayes.classes");
      ...
      case 2: {
        ...
        do {
          ptr = ::google::protobuf::io::ReadSize(ptr, &size);
          GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
          parser_till_end = ::pipelines::Vector::_InternalParse;
      ...
      case 3: {
        if (static_cast<::google::protobuf::uint8>(tag) == 26) {
          ...
          GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
          parser_till_end = ::google::protobuf::internal::PackedFloatParser;
          object = msg->mutable_class_priors();
          if (size > end - ptr) goto len_delim_till_end;
          auto newend = ptr + size;
          if (size) ptr = parser_till_end(ptr, newend, object, ctx);
          GOOGLE_PROTOBUF_PARSER_ASSERT(ptr == newend);
        ...
        do {
          msg->add_class_priors(::google::protobuf::io::UnalignedLoad<float>(ptr));
          ptr += sizeof(float);
          if (ptr >= end) break;
...
void Naive_bayes::SerializeWithCachedSizes(
  ...
  if (this->class_priors_size() > 0) {
    ...
    output->WriteVarint32(_class_priors_cached_byte_size_.load(
        std::memory_order_relaxed));
    ::google::protobuf::internal::WireFormatLite::WriteFloatArray(
...
::google::protobuf::uint8* Naive_bayes::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->class_priors_size() > 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteTagToArray(
      ...
      target);
    target = ::google::protobuf::io::CodedOutputStream::WriteVarint32ToArray(
        _class_priors_cached_byte_size_.load(std::memory_order_relaxed),
         target);
    target = ::google::protobuf::internal::WireFormatLite::
...
// @@protoc_insertion_point(message_byte_size_start:pipelines.Naive_bayes)
  ...
  // repeated float class_priors = 3;
  {
    ...
    int cached_size = ::google::protobuf::internal::ToCachedSize(data_size);
    _class_priors_cached_byte_size_.store(cached_size,
                                    std::memory_order_relaxed);
    total_size += data_size;
  }
...
// @@protoc_insertion_point(generalized_merge_from_start:pipelines.Naive_bayes)
  ...
  const Naive_bayes* source =
      ::google::protobuf::DynamicCastToGenerated<Naive_bayes>(
          &from);
  if (source == nullptr) {
...
class Linear_classifier::HasBitSetters {
 public:
};
...
#if GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
const char* Linear_classifier::_InternalParse(const char* begin, const char* end, void* object,
                  ::google::protobuf::internal::ParseContext* ctx) {
  auto msg = static_cast<Linear_classifier*>(object);
  ::google::protobuf::int32 size; (void)size;
  int depth; (void)depth;
  ::google::protobuf::uint32 tag;
  ::google::protobuf::internal::ParseFunc parser_till_end; (void)parser_till_end;
    ...
    switch (tag >> 3) {
      ...
      case 1: {
        ...
        do {
          ptr = ::google::protobuf::io::ReadSize(ptr, &size);
          GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
          ctx->extra_parse_data().SetFieldName("pipelines.Linear_classifier.classes");
          object = msg->add_classes();
          if (size > end - ptr + ::google::protobuf::internal::ParseContext::kSlopBytes) {
            parser_till_end = ::google::protobuf::internal::GreedyStringParserUTF8;
            goto string_till_end;
...
// @@protoc_insertion_point(generalized_merge_from_start:pipelines.Linear_classifier)
  ...
  const Linear_classifier* source =
      ::google::protobuf::DynamicCastToGenerated<Linear_classifier>(
          &from);
  if (source == nullptr) {
...
class Classifier::HasBitSetters {
 public:
  static const ::pipelines::Naive_bayes& nb(const Classifier* msg);
  static const ::pipelines::Linear_classifier& lc(const Classifier* msg);
};

const ::pipelines::Naive_bayes&
Classifier::HasBitSetters::nb(const Classifier* msg) {
  return *msg->classifier_.nb_;
}
const ::pipelines::Linear_classifier&
Classifier::HasBitSetters::lc(const Classifier* msg) {
  return *msg->classifier_.lc_;
}
...
#if GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
const char* Classifier::_InternalParse(const char* begin, const char* end, void* object,
                  ::google::protobuf::internal::ParseContext* ctx) {
  auto msg = static_cast<Classifier*>(object);
  ::google::protobuf::int32 size; (void)size;
  int depth; (void)depth;
  ::google::protobuf::uint32 tag;
  ::google::protobuf::internal::ParseFunc parser_till_end; (void)parser_till_end;
  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      case 1: {
        ...
        ptr = ::google::protobuf::io::ReadSize(ptr, &size);
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        parser_till_end = ::pipelines::Naive_bayes::_InternalParse;
        object = msg->mutable_nb();
        if (size > end - ptr) goto len_delim_till_end;
        ptr += size;
        GOOGLE_PROTOBUF_PARSER_ASSERT(ctx->ParseExactRange(
            {parser_till_end, object}, ptr - size, ptr));
      ...
      case 2: {
        ...
        ptr = ::google::protobuf::io::ReadSize(ptr, &size);
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        parser_till_end = ::pipelines::Linear_classifier::_InternalParse;
        object = msg->mutable_lc();
        if (size > end - ptr) goto len_delim_till_end;
        ptr += size;
        GOOGLE_PROTOBUF_PARSER_ASSERT(ctx->ParseExactRange(
            {parser_till_end, object}, ptr - size, ptr));
...
void Classifier::SerializeWithCachedSizes(
  ...
  if (has_nb()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      1, HasBitSetters::nb(this), output);
  }

  // .pipelines.Linear_classifier lc = 2;
  if (has_lc()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      2, HasBitSetters::lc(this), output);
  }
...
::google::protobuf::uint8* Classifier::InternalSerializeWithCachedSizesToArray(
  ...
  if (has_nb()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        1, HasBitSetters::nb(this), target);
  }
  ...
  if (has_lc()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        2, HasBitSetters::lc(this), target);
  }
...
// @@protoc_insertion_point(generalized_merge_from_start:pipelines.Classifier)
  ...
  const Classifier* source =
      ::google::protobuf::DynamicCastToGenerated<Classifier>(
          &from);
  if (source == nullptr) {
...
class Pipeline::HasBitSetters {
 public:
  static const ::pipelines::Classifier& classifier(const Pipeline* msg);
};

const ::pipelines::Classifier&
Pipeline::HasBitSetters::classifier(const Pipeline* msg) {
  return *msg->classifier_;
}
#if !defined(_MSC_VER) || _MSC_VER >= 1900
...
#if GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
const char* Pipeline::_InternalParse(const char* begin, const char* end, void* object,
                  ::google::protobuf::internal::ParseContext* ctx) {
  auto msg = static_cast<Pipeline*>(object);
  ::google::protobuf::int32 size; (void)size;
  int depth; (void)depth;
  ::google::protobuf::uint32 tag;
  ::google::protobuf::internal::ParseFunc parser_till_end; (void)parser_till_end;
  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      case 2: {
        ...
        ptr = ::google::protobuf::io::ReadSize(ptr, &size);
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        ctx->extra_parse_data().SetFieldName("pipelines.Pipeline.language");
      ...
      case 3: {
        ...
        ptr = ::google::protobuf::io::ReadSize(ptr, &size);
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        ctx->extra_parse_data().SetFieldName("pipelines.Pipeline.timestamp");
      ...
      case 4: {
        ...
        do {
          ptr = ::google::protobuf::io::ReadSize(ptr, &size);
          GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
          parser_till_end = ::pipelines::Transformation::_InternalParse;
          object = msg->add_representation();
          if (size > end - ptr) goto len_delim_till_end;
          ptr += size;
          GOOGLE_PROTOBUF_PARSER_ASSERT(ctx->ParseExactRange(
              {parser_till_end, object}, ptr - size, ptr));
      ...
      case 5: {
        ...
        ptr = ::google::protobuf::io::ReadSize(ptr, &size);
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        parser_till_end = ::pipelines::Classifier::_InternalParse;
        object = msg->mutable_classifier();
        if (size > end - ptr) goto len_delim_till_end;
        ptr += size;
        GOOGLE_PROTOBUF_PARSER_ASSERT(ctx->ParseExactRange(
            {parser_till_end, object}, ptr - size, ptr));
...
void Pipeline::SerializeWithCachedSizes(
  ...
  if (this->has_classifier()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      5, HasBitSetters::classifier(this), output);
  }
...
::google::protobuf::uint8* Pipeline::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0,
    ...
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        4, this->representation(static_cast<int>(i)), target);
  }
  ...
  if (this->has_classifier()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        5, HasBitSetters::classifier(this), target);
  }
...
// @@protoc_insertion_point(generalized_merge_from_start:pipelines.Pipeline)
  ...
  const Pipeline* source =
      ::google::protobuf::DynamicCastToGenerated<Pipeline>(
          &from);
  if (source == nullptr) {
...
namespace google {
namespace protobuf {
template<> PROTOBUF_NOINLINE ::pipelines::To_lower* Arena::CreateMaybeMessage< ::pipelines::To_lower >(Arena* arena) {
  return Arena::CreateInternal< ::pipelines::To_lower >(arena);
}
template<> PROTOBUF_NOINLINE ::pipelines::Hash_ngram* Arena::CreateMaybeMessage< ::pipelines::Hash_ngram >(Arena* arena) {
  return Arena::CreateInternal< ::pipelines::Hash_ngram >(arena);
}
template<> PROTOBUF_NOINLINE ::pipelines::Transformation* Arena::CreateMaybeMessage< ::pipelines::Transformation >(Arena* arena) {
  return Arena::CreateInternal< ::pipelines::Transformation >(arena);
}
template<> PROTOBUF_NOINLINE ::pipelines::Vector* Arena::CreateMaybeMessage< ::pipelines::Vector >(Arena* arena) {
  return Arena::CreateInternal< ::pipelines::Vector >(arena);
}
template<> PROTOBUF_NOINLINE ::pipelines::Naive_bayes* Arena::CreateMaybeMessage< ::pipelines::Naive_bayes >(Arena* arena) {
  return Arena::CreateInternal< ::pipelines::Naive_bayes >(arena);
}
template<> PROTOBUF_NOINLINE ::pipelines::Linear_classifier* Arena::CreateMaybeMessage< ::pipelines::Linear_classifier >(Arena* arena) {
  return Arena::CreateInternal< ::pipelines::Linear_classifier >(arena);
}
template<> PROTOBUF_NOINLINE ::pipelines::Classifier* Arena::CreateMaybeMessage< ::pipelines::Classifier >(Arena* arena) {
  return Arena::CreateInternal< ::pipelines::Classifier >(arena);
}
template<> PROTOBUF_NOINLINE ::pipelines::Pipeline* Arena::CreateMaybeMessage< ::pipelines::Pipeline >(Arena* arena) {
